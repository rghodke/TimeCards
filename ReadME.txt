...
NEW COMMIT:
--------------------------------------------------------------------------------------------------------------------------Update with another feature and working code
...
NEW COMMIT:
--------------------------------------------------------------------------------------------------------------------------
Recommented all the code due to recent GitHub terminal malfuncitions and added a new feature. Unforutnately, project will go on hiatus.
Stuff that has been done:
...
.
Can go back views now to add more words and defintions

Stuff to be done:
Flashcard view and other views are a bit buggy
Need to fix minor bugs
Potential to add the TimeFeature on the new View(View 5)